...
export function DesignAgency() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-background via-background to-muted/20 text-foreground">
      {/* Header */}
      <motion.header
        initial={{ y: -100 }}
        animate={{ y: 0 }}
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6 border border-muted rounded-3xl bg-gradient-to-br from-background to-muted/30 mx-auto">
            <div className="grid gap-3 lg:grid-cols-[1fr_400px] lg:gap-3 xl:grid-cols-[1fr_600px]">
              <motion.div
                ...
                viewport={{ once: true }}
                variants={fadeIn}
                className="flex flex-col justify-center space-y-4 py-10 pl-6"
              >
        ...
        <section id="clients" className="w-full py-12 md:py-16 lg:py-20">
          ...
          >
            <div className="flex flex-col items-center justify-center space-y-4 text-center py-10">
              <div className="space-y-3">
                <motion.div
                  ...
                  whileInView={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 0.5 }}
                  className="inline-block rounded-3xl bg-muted px-3 py-1 text-sm bg-background/50"
                >
                  Trusted by
                </motion.div>
                <motion.h2
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true }}
              className="mx-auto grid grid-cols-2 items-center gap-3 py-8 md:grid-cols-3 lg:grid-cols-6 px-6"
            >
              {[...Array(6)].map((_, i) => (
                <motion.div
                  key={i}
                ...
                >
                  <div className="rounded-3xl border p-6 bg-background/80 hover:shadow-md transition-all w-full flex justify-center">
                    <img
        ...
        <section id="services" className="w-full py-12 md:py-24 lg:py-32">
          ...
          >
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true }}
              className="mx-auto grid max-w-5xl items-center gap-6 py-12 md:grid-cols-2 lg:grid-cols-3 px-6"
            >
              {[
                {
        ...
        <section id="work" className="w-full py-12 md:py-24 lg:py-32 xl:py-48">
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            variants={fadeIn}
            className="container px-4 md:px-6 border border-muted rounded-3xl bg-muted/10 mx-auto"
          >
            <div className="flex flex-col items-center justify-center space-y-4 text-center py-10">
              <div className="space-y-3">
                <motion.div
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true }}
              className="mx-auto grid max-w-7xl gap-4 p-6 md:grid-cols-4 md:grid-rows-2"
            >
              {/* Bento Grid Items */}
              <motion.div
                variants={itemFadeIn}
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6 text-white opacity-0 transition-opacity group-hover:opacity-100 z-20">
                  ...
                  >
                    <Button
                      variant="outline"
                      size="sm"
                      className="rounded-3xl bg-white/20 backdrop-blur-sm border-white/40 text-black hover:bg-white/30"
                    >
        ...
        <section id="about" className="w-full py-12 md:py-24 lg:py-32">
          <motion.div
            ...
            className="container px-4 md:px-6 border border-muted rounded-3xl mx-auto"
          >
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 p-6">
              <motion.div
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          ...
          >
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true }}
              className="mx-auto grid max-w-5xl gap-4 py-12 lg:grid-cols-2 px-6"
            >
              {[
                {
                  quote:
        ...
        <section id="contact" className="w-full py-12 md:py-24 lg:py-32">
          <motion.div
            ...
            viewport={{ once: true }}
            variants={fadeIn}
            className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 border border-muted rounded-3xl mx-auto"
          >
            <motion.div
              initial={{ opacity: 0, x: -50 }}
              whileInView={{ opacity: 1, x: 0 }}
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6 }}
              className="rounded-3xl border bg-background p-6 shadow-sm mb-6 mr-6"
            >
      ...
      <footer className="w-full border-t">
        <motion.div
          ...
          viewport={{ once: true }}
          variants={fadeIn}
          className="container grid gap-6 px-4 py-10 md:px-6 lg:grid-cols-4 border-x border-muted mx-auto"
        >
          <div className="space-y-3">
            <a href="#" className="flex items-center space-x-3">
              <motion.div
